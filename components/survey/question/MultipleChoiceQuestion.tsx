...
const MultipleChoiceQuestion = ({message, onNext, onPrevious, onChange, choices, initialValues, enableNextButton}: MultipleChoicesQuestionProps) => {
    ...
    useEffect(() => {
        const selected = selectedIndices.reduce((acc: number[], v: boolean, i: number) => v? [...acc, i] : acc, []);
            ...
            {choices.map((choice, index) => (
                <View key={index} style={styles.checkboxContainer}>
                    <Checkbox
                        ...
                        onValueChange={(v) => setSelectedIndices(prev => {
