...
import Footer from "@/components/survey/common/Footer";
...
const BaseSurveyLayout = ({children, iconType, onNext, onPrevious, nextButtonLabel = "Next", enableNextButton}: BaseQuestionProps) => {
    return (
...
export default BaseSurveyLayout;
